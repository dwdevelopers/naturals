        ...
        <div class="topbar">
            <div class="container">
                <div class="row topbar-row">
                    ...
                    <div class="info">
                            <div class="info-item">
                            <a href="tel:0487 – 242 6366"><span class="topbar-info">Call Us: 0487 – 242 6366 </span></a><a href="tel:+91 8078900222 "> <span class="topbar-info topbar-info-2">+91 8078900222</span></a>
                            </div>
                            <div class="info-item">
                ...
                <div class="row">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="{{ asset('website/images/kairali-Logo.png') }}" alt="" />
                        </a>
                    </div>
                    ...
                    <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" data-hover="dropdown" data-animations="fadeInDown fadeInRight fadeInUp fadeInLeft">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Downloads<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="faq.html">Faq</a></li>
                                <li><a href="pricing-table.html">Pricing Table</a></li>
                                <li><a href="404page.html">404 Page</a></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Branches<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="faq.html">Faq</a></li>
                                <li><a href="pricing-table.html">Pricing Table</a></li>
                                <li><a href="404page.html">404 Page</a></li>
