...
@section('content')
            ...
            <div class="grid sm:grid-cols-2 md:gap-[30px] gap-[16px]">
                <div class="left">
                    <a href="shop-breadcrumb1.html"
                        class="collection-item block h-full relative md:rounded-[20px] rounded-xl overflow-hidden cursor-pointer">
                        ...
                        <div
                            class="collection-name heading5 text-center sm:bottom-[30px] bottom-4 lg:w-[200px] md:w-auto max-lg:px-5 lg:py-3 py-1.5 bg-white rounded-xl duration-500">
                            Body</div>
                    </a>
                </div>
                <div class="right grid grid-rows-2 md:gap-[30px] gap-[16px]">
                    <div class="top grid grid-cols-2 md:gap-[30px] gap-[16px]">
                        <a href="shop-breadcrumb1.html"
                            class="collection-item block relative md:rounded-[20px] rounded-xl overflow-hidden cursor-pointer">
                    ...
                    <div class="bottom">
                        <a href="shop-breadcrumb1.html"
                            class="collection-item block relative md:rounded-[20px] rounded-xl overflow-hidden cursor-pointer">
                            <div class="bg-img h-full">
                                <img src="{{ asset('website/assets/images/collection/accessories-cos.png')}}" alt="accessories-cos"
    ...
    <div class="community-story-block md:mt-20 mt-10">
        <div class="container">
            ...
            <div
                class="list-product grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 md:gap-[30px] gap-[16px] md:mt-10 mt-6">
                <div class="product-item block h-full relative aspect-[3/4] md:rounded-2xl rounded-xl overflow-hidden cursor-pointer"
                    data-item="53">
                    ...
                    <div
                        class="product-infor flex items-center sm:gap-4 gap-2 absolute sm:left-5 left-3 sm:bottom-5 bottom-3 w-full">
                        <div
                            class="product-img sm:w-[52px] w-10 sm:h-[52px] h-10 rounded-full overflow-hidden flex-shrink-0">
                            <img src="{{ asset('website/assets/images/product/cosmetic/1-1.png')}}" alt="8-1"
                ...
                <div class="product-item block h-full aspect-[3/4] relative md:rounded-2xl rounded-xl overflow-hidden cursor-pointer"
                    data-item="45">
                    ...
                    <div
                        ...
                        <div
                            class="product-img sm:w-[52px] w-10 sm:h-[52px] h-10 rounded-full overflow-hidden flex-shrink-0">
                            <img src="{{ asset('website/assets/images/product/1000x1000.png')}}" alt="4-1"
                                class="w-full h-full object-cover" />
                        </div>
                        <div class="product-name w-full">
                            <div class="text-white capitalize">Tinted eye Balm</div>
                ...
                <div class="product-item block h-full aspect-[3/4] relative md:rounded-2xl rounded-xl overflow-hidden cursor-pointer"
                    ...
                    <div
                        ...
                        <div
                            class="product-img sm:w-[52px] w-10 sm:h-[52px] h-10 rounded-full overflow-hidden flex-shrink-0">
                            <img src="{{ asset('website/assets/images/product/1000x1000.png')}}" alt="3-1"
                                class="w-full h-full object-cover" />
                        </div>
                        <div class="product-name w-full">
                ...
                <div class="product-item block h-full aspect-[3/4] relative md:rounded-2xl rounded-xl overflow-hidden cursor-pointer"
                    ...
                    <div
                        ...
                        <div
                            class="product-img sm:w-[52px] w-10 sm:h-[52px] h-10 rounded-full overflow-hidden flex-shrink-0">
                            <img src="{{ asset('website/assets/images/product/1000x1000.png')}}" alt="5-1"
                                class="w-full h-full object-cover" />
                        </div>
                        <div class="product-name w-full">
                            <div class="text-white capitalize">Tinted eye Balm</div>
        ...
        <div class="container lg:flex items-center">
            <div class="heading lg:w-1/4 lg:pr-[15px] max-lg:pb-8">
                ...
                <a href="shop-breadcrumb-img.html"
                    class="text-button pb-1 border-b-2 border-black duration-300 hover:border-green">Shop Now</a>
            </div>
                        ...
                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            ...
                            <div class="product-img w-full h-full aspect-[3/4]">
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/cosmetic/1-1.png')}}" alt="img" />
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/cosmetic/1-2.png')}}" alt="img" />
                            </div>
                            ...
                            <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                ...
                                <div class="quick-shop-block absolute left-5 right-5 bg-white p-5 rounded-[20px]">
                                    <div class="list-size flex items-center justify-center flex-wrap gap-2">
                                        <div
                                            class="size-item px-4 py-2 rounded-full flex items-center justify-center text-button bg-white border border-line">
                                            100ml</div>
                                        <div
                                            class="size-item px-4 py-2 rounded-full flex items-center justify-center text-button bg-white border border-line">
                                            200ml</div>
                        ...
                        <div class="product-infor mt-4 lg:mb-7">
                            ...
                            <div
                                ...
                                <div class="color-item w-12 h-12 rounded-xl duration-300 relative">
                                    <img src="{{ asset('website/assets/images/product/cosmetic/1-1.png')}}" alt="color"
                ...
                <div class="product-item grid-type" data-item="52">
                    <div class="product-main cursor-pointer block">
                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            ...
                            <div class="product-img w-full h-full aspect-[3/4]">
                                <img class="w-full h-full object-cover duration-700"
                                    src="./assets/images/product/cosmetic/1-3.png" alt="img" />
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/cosmetic/1-4.png')}}" alt="img" />
                            </div>
                            <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                <div
                                    class="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-white hover:bg-black hover:text-white">
                ...
                <div class="product-item grid-type" data-item="49">
                    <div class="product-main cursor-pointer block">
                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            ...
                            <div class="product-img w-full h-full aspect-[3/4]">
                                <img class="w-full h-full object-cover duration-700"
                                    src="./assets/images/product/cosmetic/3-1.png" alt="img" />
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/cosmetic/4-1.png')}}" alt="img" />
                            </div>
                            <div class="countdown-time-block py-1.5 flex items-center justify-center">
                                <div class="text-xs font-semibold uppercase text-red">
                                    <span class="countdown-day">24</span>
                        ...
                        <div class="product-infor mt-4 lg:mb-7">
                            ...
                            <div
                                class="list-color list-color-image max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                <div class="color-item w-12 h-12 rounded-xl duration-300 relative">
                                    <img src="{{ asset('website/assets/images/product/cosmetic/3-1.png')}}" alt="color"
                                        class="rounded-xl w-full h-full object-cover" />
                                    <div
                                        class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">
                                        Yellow</div>
                ...
                <div class="product-item grid-type">
                    <div class="product-main cursor-pointer block">
                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                            ...
                            <div class="product-img w-full h-full aspect-[3/4]">
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/1000x1000.png')}}" alt="img" />
                                <img class="w-full h-full object-cover duration-700"
                                    src="{{ asset('website/assets/images/product/1000x1000.png')}}" alt="img" />
                            </div>
                            <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
    ...
    <div class="buy-pack-block md:pt-20 pt-10">
        <div
            class="container grid sm:grid-cols-2 max-sm:flex max-sm:w-full flex-col max-sm:flex-col-reverse items-center">
            <div class="main-content w-full">
                ...
                <div class="list-product mt-8">
                    <div class="product-item pb-5 border-b border-line cursor-pointer" data-item="43">
                        <div class="product-main flex items-center justify-between">
                            <div class="left flex items-center gap-7">
                                <img src="{{ asset('website/assets/images/product/cosmetic/6-1.png')}}" alt="1-1"
                    ...
                    <div class="product-item pb-5 border-b border-line cursor-pointer mt-5" data-item="44">
                        <div class="product-main flex items-center justify-between">
                            <div class="left flex items-center gap-7">
                                <img src="{{ asset('website/assets/images/product/cosmetic/7-1.png')}}" alt="1-2"
                                    class="w-[60px] h-20 flex-shrink-0 object-cover" />
                                <div class="infor">
                    ...
                    <div class="product-item pb-5 border-b border-line cursor-pointer mt-5" data-item="42">
                        <div class="product-main flex items-center justify-between">
                            <div class="left flex items-center gap-7">
                                <img src="{{ asset('website/assets/images/product/cosmetic/3-1.png')}}" alt="1-3"
                                    class="w-[60px] h-20 flex-shrink-0 object-cover" />
                                <div class="infor">
            ...
            <div class="popular-product sm:pl-20 max-sm:pb-6 max-sm:px-8">
                <div class="item relative">
                    <img src="{{ asset('website/assets/images/product/cosmetic/1-4.png')}}" alt="/images/product/cosmetic/1-4.png"
                    ...
                    <div class="dots absolute top-[20%] left-[20%] cursor-pointer">
                        ...
                        <div class="product-item product-infor bg-white rounded-2xl p-4" data-item="43">
                            ...
                            <div
                                class="text-center underline mt-1 text-button-uppercase duration-300 text-secondary2 hover:text-black">
                                View</div>
                        </div>
                    </div>
                ...
                <figure class="image-comparison__figure image-comparison__figure--overlay">
                    <picture class="image-comparison__picture">
                        ...
                        <source media="(min-width: 40.0625em) and (max-width: 48em)"
                            srcset="{{ asset('website/assets/images/banner/before.png')}}" />
                        <img src="{{ asset('website/assets/images/banner/before.png')}}" alt="Mojave desert in the sun"
                            class="image-comparison__image" />
                    </picture>

                    <figcaption
                        class="image-comparison__caption image-comparison__caption--before absolute top-5 left-5 heading5 px-6 py-3 rounded-[30px] bg-surface2 text-white">
            ...
            <div class="image-comparison__image-wrapper">
                <figure class="image-comparison__figure">
                    <picture class="image-comparison__picture">
                        ...
                        <source media="(min-width: 40.0625em) and (max-width: 48em)"
                            srcset="{{ asset('website/assets/images/banner/after.png')}}" />
                        <img src="{{ asset('website/assets/images/banner/after.png')}}" alt="Mojave desert in the dark"
                            class="image-comparison__image" />
                    </picture>

                    <figcaption
                        class="image-comparison__caption image-comparison__caption--after absolute top-5 right-5 heading5 px-6 py-3 rounded-[30px] bg-surface2 text-white">
                ...
                <div class="menu-tab flex items-center bg-surface rounded-2xl">
                    <div class="menu flex items-center gap-2 p-1">
                        ...
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black active"
                            data-item="eye">eye</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="hair">hair</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="face">face</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="lip">lip</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="nail">nail</div>
                    </div>
                </div>
            </div>
            <div
                class="list-product four-product hide-product-sold grid xl:grid-cols-4 sm:grid-cols-3 grid-cols-2 md:gap-[30px] gap-4 relative section-swiper-navigation style-outline style-small-border md:mt-10 mt-6">
                <!-- List four product -->
            </div>
        </div>
    </div>
    ...
    <div class="benefit-block md:py-20 py-10">
        <div class="container">
            <div
                class="list-benefit grid items-start md:grid-cols-3 grid-cols-1 xl:gap-[160px] lg:gap-20 gap-10 gap-y-6">
        ...
        <div class="container relative w-full h-full">
            <div class="content md:w-1/2 lg:py-[110px] py-16">
                ...
                <div class="flex items-center gap-5 mt-8">
                    <div class="avatar">
                        <img src="{{ asset('website/assets/images/avatar/1.png')}}" alt="avatar"
                            class="sm:w-20 w-14 sm:h-20 h-14 rounded-full" />
                    </div>
                    <div class="infor">
    ...
    <div class="container">
        <div
            class="newsletter-block bg-transparent md:py-20 sm:py-14 py-10 sm:px-8 px-6 sm:rounded-[32px] rounded-3xl flex flex-col items-center">
            ...
            <div class="input-block lg:w-1/2 sm:w-3/5 w-full h-[52px] sm:mt-10 mt-7">
                <form class="w-full h-full relative">
                    ...
                    <button
                        class="button-main absolute top-1 bottom-1 right-1 flex items-center justify-center">Subscribe</button>
                </form>
            </div>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                ...
                                <img src="{{ asset('website/assets/images/instagram/11.png')}}" alt="0"
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/12.png')}}" alt="1"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/13.png')}}" alt="2"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/14.png')}}" alt="3"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/15.png')}}" alt="4"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/16.png')}}" alt="5"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.instagram.com/" target="_blank"
                                class="item relative block overflow-hidden">
                                <img src="{{ asset('website/assets/images/instagram/yoga7.png')}}" alt="10"
                                    class="h-full w-full duration-500 relative" />
                                <div
                                    class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                    <div class="icon-instagram text-2xl text-black"></div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/1.png')}}" alt="1"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/2.png')}}" alt="2"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/3.png')}}" alt="3"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/4.png')}}" alt="4"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/5.png')}}" alt="5"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/6.png')}}" alt="6"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item relative flex items-center justify-center h-[36px]">
                                <img src="{{ asset('website/assets/images/brand/7.png')}}" alt="7"
                                    class="h-full w-auto duration-500 relative object-cover" />
                            </div>
                        </div>
                    </div>
